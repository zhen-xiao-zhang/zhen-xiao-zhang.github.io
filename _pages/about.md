...
- [Online Client Scheduling and Resource Allocation for Efficient Federated Edge Learning](https://ieeexplore.ieee.org/document/11181192), Yu Zhang, Zhidong Gao, **Zhenxiao Zhang**, Tongnian Wang, Yanmin Gong, Yuanxiong Guo, IEEE Transactions on Vehicular Technology (TVT), 2025.
...
- [Heterogeneity-Aware Cooperative Federated Edge Learning with Adaptive Computation and Communication Compression](https://ieeexplore.ieee.org/document/10745729), **Zhenxiao Zhang**, Zhidong Gao, Yuanxiong Guo, Yanmin Gong, IEEE Transactions on Mobile Computing (TMC), 2024.
...
- [pFedSAM: Secure Federated Learning Against Backdoor Attacks via Personalized Sharpness-Aware Minimization](https://ieeexplore.ieee.org/document/11161540), **Zhenxiao Zhang**, Yuanxiong Guo, Yanmin Gong, IEEE International Conference on Computer Communications (ICC), 2025. 
